...
**In Diesel You can server static files via *`app.static()`* method**
...
// // server static files and SPA
// // public folder can have -> html file , css , javascript files

// in app.static add -> import.meta.dir+"/public"
